...
$sql="INSERT INTO tbltourhotel(HotelName,HotelType,HotelLocation,HotelPrice,HotelFetures,HotelDetails,HotelImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
...
<html>
<head>
<title>Admin hotel Creation</title>
...
<?php include('includes/header.php');?>
	...
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Update Hotel </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotelprice" id="hotelprice" placeholder=" hotel Price is INR" required>
									</div>
								</div>
