...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Hotel List</h1>
	</div>
</div>
<div class="rooms">
	<div class="container">
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5><?=$CURR?> <?php echo htmlentities($result->HotelPrice);?></h5>
